...
public class SingleVectorSearch {
    ...
    //FloatVec queryVector = new FloatVec(new float[]{
    // 0.35f, -0.60f, 0.18f, -0.26f, 0.90f});
    ...
    FloatVec queryVector = new FloatVec(new float[]{0.3580376395471989f,
            -0.6023495712049978f, 0.18414012509913835f,
